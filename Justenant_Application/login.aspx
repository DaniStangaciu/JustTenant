<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="Justenant_Application.login" %>
...
<body>
    ...
    <div id="signup">
        <p style="font-size: 25px; text-align: left;">JusTenant Login</p>
        <form>
            <div class="mb-3">
                <label for="email" class="form-label">Email address</label>
                <asp:TextBox ID="email" class="form-control" aria-describedby="emailHelp" runat="server"></asp:TextBox>     
            </div>
            ...
            <asp:Button ID="submit" class="btn btn-secondary" runat="server" Text="Login" BackColor="#666666" Font-Names="Arial" OnClick="submit_Click" />
        </form>
        Don't have an account? Click <a href="signup.aspx">here</a>.
    </div>
